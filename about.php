            ...
            <div class="col-lg-6 align-self-center  wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="about-right-content">
                <div class="section-heading">
                  <h6>About Us</h6>
                  <h4>Who is <em>DreamJob</em></h4>
                  <div class="line-dec"></div>
                </div>
                <p>This web page is about a requirement computer system, the web site provide unique job operjunity for job seekers, recruitment is a process of searching for prospective employee,the purpose of this web portal is providing job opportunities for potentially qualified job candidates.</p>
                </div> 
              </div>
            </div>
          </div>
