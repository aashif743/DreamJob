  ...
  <!-- ***** Header Area End ***** -->
    ...
    <div class="container">
        <div class="col-lg-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s"><br><br><br><br><br><br>
          <form id="contact" method="POST" enctype="multipart/form-data" action="stafffile.php">
            <div class="row">
              <div class="col-lg-5">
                ...
                <div class="fill-form">
                  <div class="row">
                    <h4>Staff Assistant Application</h4>
                    <div class="col-lg-6">
                      <fieldset>
                    ...
                    <div class="col-lg-6">
                      ...
                      <fieldset>
                        <input type="text" name="oindex" id="oindex" placeholder="Index Number" required="">
                      </fieldset>
                      <fieldset>
                    ...
                    <div class="col-lg-6">
                      <fieldset>
                        <label style="margin-top: 30px; font-size: 12px; float: left; margin-left: 20px;"><b>G.C.E Advance Level Examination</b></label>
                        <input type="text" name="al" id="al" placeholder="Year" autocomplete="on" required>
                      </fieldset>
                      <fieldset>
                        <input type="text" name="aindex" id="aindex" placeholder="Index Number" required="">
                      </fieldset>
                      <fieldset>
